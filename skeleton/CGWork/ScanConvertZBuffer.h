...
void renderPolygon(Point* zBuffer, size_t width, size_t height, const Poly& polygon, const Vector4& cameraPosition,
	bool doBackFaceCulling, bool applyMarbleTexture, bool applyWoodTexture, bool applyWaterTexture, float t);
